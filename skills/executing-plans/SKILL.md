...
**Note:** Tell your human partner that Baspowers works much better with access to subagents (Claude Code, Codex CLI, Codex App, Copilot CLI, and Gemini CLI all qualify; see the per-platform tool refs in `../using-baspowers/references/`). If subagents are available, use baspowers:subagent-driven-development instead of this skill.

## The Process

### Step 1: Load and Review Plan
1. Ensure an isolated workspace: use baspowers:using-git-worktrees to create one or verify the existing one
2. Read plan file
...
- **REQUIRED SUB-SKILL:** Use baspowers:finishing-a-development-branch
