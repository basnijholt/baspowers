...
- Eval campaign closeout: `baspowers-autoresearch/reports/2026-07-codex-efficiency-campaign.md`
  (treatment table §4; every treatment below has a scorer and a measured
  `dev` baseline).
- Codex source recon: `baspowers-autoresearch/docs/2026-07-29-codex-multiagent-v2-capabilities.md`
  (file:line citations against the Codex CLI source; grounds T2, T3, T5).
- Published experiment write-ups: `baspowers-evals/docs/experiments/`.
...
campaign as baspowers skill/doc changes, each graded against its
...
**Changes** (`skills/using-baspowers/references/codex-tools.md`):
...
`skills/using-baspowers/references/codex-tools.md` to be
...
- **Pre-registration:** every battery gets a hypothesis-log entry
  ...
  `baspowers-autoresearch/logs/2026-07-30-codex-efficiency-fixes.md`
...
- Scenario/rig changes (un-gating ceremony scenarios for Claude
  Code/Gemini, adversarial micro briefs) land in `baspowers-evals`
  main, as authorized.
