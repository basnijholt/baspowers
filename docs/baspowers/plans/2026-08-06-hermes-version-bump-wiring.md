...
**Spec:** `docs/baspowers/specs/2026-08-05-hermes-version-bump-wiring-design.md`
...
make_fixture "$happy_repo" $'name: baspowers\nversion: 1.2.3'
...
make_fixture "$invalid_repo" $'name: baspowers\nversion: 123'
