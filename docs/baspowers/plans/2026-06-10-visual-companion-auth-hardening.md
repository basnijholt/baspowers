...
```bash
cd /Users/drewritter/prime-rad/baspowers/tests/brainstorm-server
node auth.test.js
```
...
```bash
cd /Users/drewritter/prime-rad/baspowers
...
```bash
cd /Users/drewritter/prime-rad/baspowers
git check-ignore .baspowers/brainstorm/.last-token || true
```
...
```bash
cd /Users/drewritter/prime-rad/baspowers
git check-ignore .baspowers/brainstorm/.last-token
```

Expected output:

```text
.baspowers/brainstorm/.last-token
```
...
```bash
node /tmp/baspowers-pr1720-security-drewritter/probe-pr1720.cjs
```
