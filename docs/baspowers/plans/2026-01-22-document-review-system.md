...
> **For agentic workers:** REQUIRED: Use baspowers:subagent-driven-development (if subagents available) or baspowers:executing-plans to implement this plan.
...
**Spec:** docs/baspowers/specs/2026-01-22-document-review-system-design.md
...
**Dispatch after:** Spec document is written to docs/baspowers/specs/
...
```markdown
> **For agentic workers:** REQUIRED: Use baspowers:subagent-driven-development (if subagents available) or baspowers:executing-plans to implement this plan. Tasks and steps use checkbox (`- [ ]`) syntax for tracking.
```
