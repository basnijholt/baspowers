...
## Is this a Baspowers issue or a platform issue?
<!-- Baspowers is a plugin. Some reported "bugs" are actually issues
     in the underlying platform or model. If you're not sure, try
     reproducing without Baspowers installed.

     If the problem persists without Baspowers, file the issue with
     your platform instead. -->

- [ ] I confirmed this issue does not occur without Baspowers installed
